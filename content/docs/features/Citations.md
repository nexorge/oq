...
Citation parsing is a functionality of the [[content/docs/plugins/Citations|Citation]] plugin. **This plugin is not enabled by default**. See the plugin page for customization options.
